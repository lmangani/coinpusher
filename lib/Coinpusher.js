...
class Coinpusher extends EventEmitter {
    ...
    startForBitcoin() {
        return this.start(CURRENCY.BTC_EUR, process.env.PORT || 3333);
    }

    startForEthereum() {
        return this.start(CURRENCY.ETH_EUR, process.env.PORT || 3334);
    }

    startForLitecoin() {
        return this.start(CURRENCY.LTC_EUR, process.env.PORT || 3335);
    }
