...
class SocketServer extends EventEmitter {
    ...
    _registerHttpEndpoints(app) {
        ...
        app.get("/", (req, res) => {
            ...
            <li><a href="/graph/performance.html">graph/performance.html<a></li>
            <li><a href="/coinstreams">coinstreams<a></li>
            <li><a href="/currencies">currencies<a></li>
            <li><a href="/reset-stats">reset-stats<a></li>
            <li><a href="/stats">stats<a></li>
            <li><a href="/nn/train/btceur">nn/train/btceur<a></li>
            <li><a href="/nn/status">nn/status<a></li>
            `
            ...
            {
            "/graph": req.protocol + "://" + req.headers.host + `/graph`,
            "/graph/performance.html": req.protocol + "://" + req.headers.host + `/graph/performance.html`,
            "/coinstreams": req.protocol + "://" + req.headers.host + `/coinstreams`,
            "/currencies": req.protocol + "://" + req.headers.host + `/currencies`,
            "/reset-stats": req.protocol + "://" + req.headers.host + `/reset-stats`,
            "/stats": req.protocol + "://" + req.headers.host + `/stats`,
            "/nn/train/:currency": req.protocol + "://" + req.headers.host + `/nn/train/etheur`,
            "/nn/status": req.protocol + "://" + req.headers.host + `/nn/status`
        }*/
        });
